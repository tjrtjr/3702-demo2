...
| 2026-09-10 | Simplify project documentation and remove unused scaffolding and local course example copies at the student's request. | Retained run commands, source attribution, measured results and explicit outstanding requirements. |
